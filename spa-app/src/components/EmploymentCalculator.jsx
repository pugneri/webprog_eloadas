        ...
        <div className="miniapp-card">
            ...
            <form className="miniapp-form" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                ...
                <div style={{ display: "flex", columnGap: "12px", rowGap: "14px", flexWrap: "wrap", marginTop: "12px" }}>
                    ...
                    <button type="button" onClick={() => { setFormData({ mezogazdasag: "", ipar: "", szolgaltatas: "" }); setSubmitted(false); }}>Új számítás</button>
                </div>
            </form>
			{submitted && (
				<div
				...
				>
					...
					<p style={{ color: "#475569", fontStyle: "italic", marginBottom: "14px" }}>
						Foglalkoztatási összesítő kártya
					</p>

					<p style={{ marginBottom: "8px" }}>
						<strong>Összes foglalkoztatott:</strong> {values.total}
					</p>
					<p style={{ marginBottom: "8px" }}>
						<strong>Mezőgazdaság aránya:</strong> {values.mezogazdasagPercent}%
					</p>
					<p style={{ marginBottom: "8px" }}>
						<strong>Ipar aránya:</strong> {values.iparPercent}%
					</p>
					<p style={{ marginBottom: "0" }}>
						<strong>Szolgáltatás aránya:</strong> {values.szolgaltatasPercent}%
					</p>
				</div>
			)}
        </div>
